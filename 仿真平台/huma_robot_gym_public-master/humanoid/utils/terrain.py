...
class Terrain:
    def __init__(self, cfg: LeggedRobotCfg.terrain, num_robots) -> None:
        ...
        if self.type=="trimesh":
            logger.info("Converting heightmap to trimesh...")
            ...
            logger.info("Created {} vertices".format(self.vertices.shape[0]))
            logger.info("Created {} triangles".format(self.triangles.shape[0]))
...
def parkour_wave_terrain(terrain,
                           platform_len=2.5, 
                           platform_height=0., 
                           num_waves=1,
                           num_goals=8,
