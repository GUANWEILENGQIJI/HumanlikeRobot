...
class Sim2simCfg():
    ...
    class sim_config:
        ...
        mjcf_path = '{workspace_dir}/resources/robots/T1Bot/mjcf/t1pro.xml'
        model_path = '{workspace_dir}/logs/{experiment_name}/exported/policies/policy.pt'
        param_path = '{workspace_dir}/logs/{experiment_name}/exported/policies/params.yaml'
    ...
    class robot_config:
        ...
        tau_limit = [80, 100, 200, 150, 40, 80,
                     80, 100, 200, 150, 40, 80,
                     ]
