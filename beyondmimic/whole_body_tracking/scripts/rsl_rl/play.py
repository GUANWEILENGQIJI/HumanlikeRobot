...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    if args_cli.wandb_path:
        ...
        if args_cli.motion_file is None:
            ...
            if art is None:
                print("[WARN] No motion artifact found in the run and no --motion_file was provided.")
            else:
    ...
    if not getattr(env_cfg.commands.motion, "motion_file", None):
        raise ValueError("A motion file is required. Provide --motion_file or use --wandb_path with a motion artifact.")
