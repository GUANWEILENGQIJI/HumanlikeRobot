...
parser.add_argument(
    ...
    default=0.0,
    help=(
        "Constant offset subtracted from the root z position before replay/export. "
        "Use a positive value if the robot appears to float above the ground."
    ),
)
...
# Pre-defined configs
##
from whole_body_tracking.robots.t1pro import T1PRO_CFG
...
class ReplayMotionsSceneCfg(InteractiveSceneCfg):
    ...
    # articulation
    robot: ArticulationCfg = T1PRO_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
...
class MotionLoader:
    ...
    def _load_motion(self):
        ...
        self.motion_base_poss_input[:, 2] -= args_cli.root_z_offset
        ...
        print(
            ...
            f"root_z_offset: {args_cli.root_z_offset}"
        )
...
def main():
    ...
    run_simulator(
		...
		"leg_right_hip_yaw_joint",
		  ...
		  "torso_roll_joint",
		  "torso_pitch_joint",
		  "arm_right_shoulder_hunch_joint",
